  ...
  async fetch() {
    ...
    switch (media) {
      case 'movie':
        ...
        this.movie = data1;
        const recomendations1 = await fetch(`https://api.themoviedb.org/3/movie/${id}/recommendations?api_key=${process.env.API_KEY}`);
      ...
      case 'tv':
        ...
        this.movie = data2;
        const recomendations2 = await fetch(`https://api.themoviedb.org/3/tv/${id}/recommendations?api_key=${process.env.API_KEY}`);
